...
import {
  parseTop10PuzzleJson,
  type Top10Puzzle,
} from "@/content/games/top10/schema";
...
function validateReferences(p: Top10Puzzle): void {
...
export const ALL_TOP10_PUZZLES: Top10Puzzle[] = raw.map((r) => {
  const p = parseTop10PuzzleJson(r);
